            ...
            <div class="col-lg-3 col-xl-2">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('barang.create')); ?>" class="btn btn-primary"
                        style="background-color: rgb(0, 0, 0); color: rgb(255, 255, 255);">Create Barang</a>
                </div>
            </div>
        </div>
        <hr>
...
<?php /**PATH C:\Users\Asus\OneDrive\Dokumen\coding\semester 6\Framework\uts_framework_naufalyafi_1204200132\resources\views/barang/index.blade.php ENDPATH**/ ?>